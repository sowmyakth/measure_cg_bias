...
1. [notebooks](https://github.com/sowmyakth/measure_cg_bias/tree/master/notebooks)
has jupyter notebooks with images of the galaxies and PSF used in this analysis
as well as the results.
2. [data](https://github.com/sowmyakth/measure_cg_bias/tree/master/data)
...
accounted for then the estimated shapes and thus, the WL shear measurements can
be biased.
...
The reference galaxy has extreme color gradients and is not representative of all galaxies LSST
will see. We use this galaxy to place limits on the extent of CG bias.

2. Galaxies from CatSim (Catalog Simulator) with a range of color gradients. These galaxies are parametric bulge + disk models with galaxy size and color distribution that LSST is expected to see.  
...
<img src="docs/images/aegis_results.png" alt="aegis cg bias" width="600"/>
...
<img src="docs/images/results_summary.png" alt="summary" width="800"/>
